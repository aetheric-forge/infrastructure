...
pulumi.export("wireGuardPrivateIp", wireguard.private_ip if wireguard else None)
pulumi.export("wireGuardRouteNetworkInterfaceId", wireguard.route_network_interface_id if wireguard else None)
